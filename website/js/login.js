...
function changeDialog(style, text){
	switch(style){
		...
		case 2:
			...
			document.getElementById('dialog-text').innerHTML = "<div class='flex rounded-md shadow-sm'><div class='relative flex flex-grow items-stretch focus-within:z-10'><div class='pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3'><svg xmlns='http://www.w3.org/2000/svg' class='h-5 w-5 secondaryColor' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'></path><rect x='3' y='4' width='18' height='8' rx='3'></rect><rect x='3' y='12' width='18' height='8' rx='3'></rect><line x1='7' y1='8' x2='7' y2='8.01'></line><line x1='7' y1='16' x2='7' y2='16.01'></line><path d='M11 8h6'></path><path d='M11 16h6'></path></svg></div><span id='fu_server2' value='https://horbaczewski.info' class='tertiaryBackgroundColor tertiaryColor primaryBorderColor block w-full pl-10 px-3 py-2 border rounded-tl-md focus:outline-none sm:text-sm'>horbaczewski.info</span></div></div>
